package com.hym.appstore.common.utils.permission.data;
...
public class PermissionsHelper {
     ...
     * @return
     */
    public static boolean isLackOfPermission (Context context, String... permissions) {
        for (String permission : permissions) {
            boolean permissionDenied = isNotGranted (context,permission);
            if (permissionDenied) {
                return true;
            }
        }
